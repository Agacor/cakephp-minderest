...
class ProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mpn' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => 'Manufacturer Part Number', 'precision' => null],
        'nombre' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null],
        'descripcion' => ['type' => 'text', 'length' => 16777215, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null],
        'ean13' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => 'Código EAN opcional', 'precision' => null],
        ...
        '_indexes' => [
            ...
            'ean13' => ['type' => 'index', 'columns' => ['ean13'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'mpn' => ['type' => 'unique', 'columns' => ['mpn'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'ean13' => 'Lorem ipsum dolor sit amet',
                'created' => 1625411183,
                'modified' => 1625411183,
            ],
        ];
