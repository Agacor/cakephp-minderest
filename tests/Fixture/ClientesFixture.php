...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nif' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null],
        'nombre' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null],
        'observaciones' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => 'El campo de observaciones viene a representar simplemente una columna más del total de columnas que podria tener un cliente.', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'nif' => ['type' => 'unique', 'columns' => ['nif'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
